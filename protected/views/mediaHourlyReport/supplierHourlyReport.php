...
<script type="text/javascript" src="<?php echo Yii::app()->params['baseUrl']; ?>/assets/js/mediaHourlyReport.js" charset="UTF-8"></script>
...
<div id="filter">
	...
	<div id="filter-list">
		...
		<?php
			echo $this->renderPartial('_hourlyDatepick');
		?>	
		<div class="panel panel-default">
...
<div id="supplier-report">
	...
	<div><h3>供應商時報表</h3></div>

	<ul class="nav nav-tabs" role="tablist">
		<li role="presentation" class="active tabs-btn" id="def">
			<a href="#home" aria-controls="home" role="tab" data-toggle="tab">媒體時報表</a>
		</li>
...
<script>
	var reportUrl = 'supplierHourlyReport';
	<?php if( (isset($_GET['supplier_id']) && $_GET['supplier_id'] > 0)){ ?>
