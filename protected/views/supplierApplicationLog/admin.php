...
<div class="panel panel-default">
	...
	<div class="panel-body">
		...
		申請狀態
		<select name="status">
			<option value="" <?php if(!isset($_GET['status'])){ ?>selected="selected"<?php }?>>全部</option>
			<option value="1" <?php if($_GET['status'] == 1){ ?>selected="selected"<?php }?>>已退回</option>
			<option value="2" <?php if($_GET['status'] == 2){ ?>selected="selected"<?php }?>>申請中</option>
			<option value="3" <?php if($_GET['status'] == 3){ ?>selected="selected"<?php }?>>憑證已確認</option>
			<option value="4" <?php if($_GET['status'] == 4){ ?>selected="selected"<?php }?>>申請已完成</option>
		</select>
