				...
				<div class="filter-box">
					<div class="form-group id-input-group">
						<div class="input-group">
							...
							<input type="text" class="input-sm form-control id-input" id="Campaign_id" value="<?php echo $_GET['Campaign_id'];?>">
						</div>
					</div>	
				</div>
...
<div id="supplier-report">
	...
	<div><h3>媒體分類報表</h3></div>
	<ul class="nav nav-tabs" role="tablist">
		<li role="presentation" class="active tabs-btn" id="def">
			<a href="#home" aria-controls="home" role="tab" data-toggle="tab">媒體分類報表</a>
		</li>
