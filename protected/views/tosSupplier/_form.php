...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<div class="form-group">
				...
				<div><span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>此欄位為自動同步請至TOS系統修改</div>
			...
			<div class="form-group">
				...
				<div><span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>此欄位為自動同步請至TOS系統修改</div>
				<div><?php echo $model->company_name;?></div>
			</div>
			...
			<div class="form-group">
				...
				<div><span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>此欄位為自動同步請至TOS系統修改</div>
				<div><?php echo $model->company_address;?></div>
			</div>
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<div class="form-group">
				...
				<div><span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>此欄位為自動同步請至TOS系統修改</div>
				<div><?php echo $model->contacts;?></div>
			</div>
			...
			<div class="form-group">
				<label><?php echo $form->labelEx($model,'contacts_moblie'); ?></label>
					<div><span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>此欄位為自動同步請至TOS系統修改</div>
				<div><?php echo $model->contacts_moblie;?></div>
			</div>			
	...
	<div class="panel panel-default">
		<div class="panel-heading"><?php echo $form->labelEx($model,'remark'); ?></div>
		<div class="panel-body">
			<div class="form-group">
				<div><span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>此欄位為自動同步請至TOS系統修改</div>
				<div><?php echo $model->remark;?></div>
			</div>
		</div>
	</div>	
