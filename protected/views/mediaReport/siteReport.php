				...
				<div class="filter-box">
					<div class="btn-group index-btn-group" data-toggle="buttons">
						<label class="btn btn-primary active" data-status="supplier">
							<input type="radio" name="options" id="option2" autocomplete="off" checked> 網站 
						</label>					
...
<div id="supplier-report">
	...
	<div><h3>供應商網站日報表</h3></div>
	<ul class="nav nav-tabs" role="tablist">
		<li role="presentation" class="active tabs-btn" id="def">
			<a href="#home" aria-controls="home" role="tab" data-toggle="tab">網站日報表</a>
		</li>
...
<script>
	var reportUrl = 'siteReport';
	<?php if( (isset($_GET['supplier_id']) && $_GET['supplier_id'] > 0) || (isset($_GET['site_id']) && $_GET['site_id'] > 0)){ ?>
