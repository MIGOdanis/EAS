...
<div id="left-main">
	<div id="menu-list-group">
		<?php if (in_array($this->action->id, array("payments","paymentSetting","paymentsHistroy","deductAccountsHistroy"))) {?>
			...
			<div class="menu-list <?php if ($this->action->id == "deductAccountsHistroy") {?> report-site-active <?php }?> "><a href="deductAccountsHistroy">違規(扣款)紀錄</a></div>
