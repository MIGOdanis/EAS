		...
		if(isset($_GET['export']) && $_GET['export'] == 1){
			...
			foreach ($model as $value) {
				...
				if($this->user->group < 7){
					$data[] = array(
						...
						"E" => number_format($value->agency_income, 2, "." ,""),
						"F" => (($value->impression > 0) ? number_format(($value->agency_income / $value->impression) * 1000, 2, "." ,"") : 0),
						"G" => (($value->click > 0) ? number_format(($value->agency_income / $value->click), 2, "." ,"") : 0),
				...
				$click += $value->click;
				$income += $value->income;
				$agency_income += $value->agency_income;
			}
			...
			if($this->user->group < 7){
				$data[] = array(
					...
					"E" => number_format($agency_income, 2, "." ,""),
					"F" => (($impression > 0) ? number_format(($agency_income / $impression) * 1000, 2, "." ,"") : 0),
					"G" => (($click > 0) ? number_format(($agency_income / $click), 2, "." ,"") : 0),
		...
		if(isset($_GET['export']) && $_GET['export'] == 1){
			...
			foreach ($model as $value) {
				...
				if($this->user->group < 7){
					$data[] = array(
						...
						"J" => number_format($value->agency_income, 2, "." ,""),
						"K" => (($value->impression > 0) ? number_format(($value->agency_income / $value->impression) * 1000, 2, "." ,"") : 0),
						"L" => (($value->click > 0) ? number_format(($value->agency_income / $value->click), 2, "." ,"") : 0),
						"M" => number_format($value->income, 2, "." ,""),
						"N" => (($value->impression > 0) ? number_format(($value->income / $value->impression) * 1000, 2, "." ,"") : 0),
						"O" => (($value->click > 0) ? number_format(($value->income / $value->click), 2, "." ,"") : 0),						
					);
				}else{
					$data[] = array(
						"A" => date("Y-m-d",$value->settled_time),
			...
			if($this->user->group < 7){
				$data[] = array(
					...
					"J" => number_format($agency_income, 2, "." ,""),
					"K" => (($impression > 0) ? number_format(($agency_income / $impression) * 1000, 2, "." ,"") : 0),
					"L" => (($click > 0) ? number_format(($agency_income / $click), 2, "." ,"") : 0),
					"M" => number_format($value->income, 2, "." ,""),
					"N" => (($value->impression > 0) ? number_format(($value->income / $value->impression) * 1000, 2, "." ,"") : 0),
					"O" => (($value->click > 0) ? number_format(($value->income / $value->click), 2, "." ,"") : 0),						
				);
