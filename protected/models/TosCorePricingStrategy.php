<?php
class TosCorePricingStrategy extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'buyerPricingRules' => array(self::HAS_ONE, 'TosCoreBuyerPricingRules', array('refer_id' => 'id'), 'condition'=>'buyerPricingRules.status = 1'),
		);
	}
