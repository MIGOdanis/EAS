<?php
class TosCoreMediaAdRestriction extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'trafficAdRestrictionRule' => array(self::HAS_ONE, 'TosCoreTrafficAdRestrictionRule', array('restriction_id' => 'ad_restriction_id'), 'condition'=>'trafficAdRestrictionRule.status = 1'),
		);
	}
